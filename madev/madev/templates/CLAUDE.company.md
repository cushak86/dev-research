...
> 내 사업에 맞게 위 3줄을 수정하세요. 이 3줄이 모든 직원의 판단 기준이 됩니다.
...
## 13. 배포 규칙 (프로젝트에 맞게 수정)

- **배포는 `git push origin main`으로만 한다.** Netlify/Vercel CLI 등으로 직접 배포하지 마.
- 프로덕션 반영은 되돌리기 어렵다 — 사용자의 **명시적 승인**을 받은 뒤에만 실행한다.

## 14. 프로젝트별 정보 (직접 채워 넣기)

- **프로젝트 이름:**
- **사이트 URL:**
- **기술 스택:** (예: Vite + React + TypeScript)
